<%@ Page Title="" Language="C#" MasterPageFile="~/Layout/Admin.Master" AutoEventWireup="true" CodeBehind="orderEdit.aspx.cs" Inherits="OnlineHealthCareServices.Admin.orderEdit" %>
        ...
        <div class="modal-body mx-3">
             ...
             <div class="form-row">
                  <div class="col-md-6 cols-sm-12">
                      ...
                      <asp:RequiredFieldValidator ID="RequiredFieldValidator3" runat="server" ErrorMessage="*"  ForeColor="Red" SetFocusOnError="true" ControlToValidate="txtAmount"></asp:RequiredFieldValidator>
                   </div>
                   <div class="col-md-6 cols-sm-12">
                       <asp:TextBox ID="txtDiscount" runat="server" CssClass="form-control" placeholder="Discount "></asp:TextBox>
                      <asp:RequiredFieldValidator ID="RequiredFieldValidator4" runat="server" ErrorMessage="*" ForeColor="Red" SetFocusOnError="true" ControlToValidate="txtDiscount"></asp:RequiredFieldValidator>
                   </div>
             </div>
             <div class="form-row">
                   ...
                   <div class="col-md-6 cols-sm-12">
                      ...
                      <asp:RequiredFieldValidator ID="RequiredFieldValidator6" runat="server" ErrorMessage="*" ForeColor="Red" SetFocusOnError="true" ControlToValidate="ddlStatus"></asp:RequiredFieldValidator>
                   </div>
