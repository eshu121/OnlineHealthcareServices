<%@ Page Title="" Language="C#" MasterPageFile="~/Layout/Admin.Master" AutoEventWireup="true" CodeBehind="lab_Test.aspx.cs" Inherits="OnlineHealthCareServices.Admin.lab_Test" %>
                ...
                <div class="container a1 table">
                    <div class="row">
                        ...
                        <div class="col-md-4 cols-sm-12">
                            ...
                            <div class="col-md-12 col-sm-12">
                                <a href="test_History.aspx?TestId=<%# Eval("labTestId")%>" style='padding: 5px 15px 5px 15px; background-color:#5aba1d; color:#fff; border-radius:5px;'>View Test</a>
                            </div>
