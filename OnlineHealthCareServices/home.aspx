<%@ Page Title="" Language="C#" MasterPageFile="~/Layout/MyMaster.Master" AutoEventWireup="true" CodeBehind="home.aspx.cs" Inherits="OnlineHealthCareServices.home" %>
             ...
             <marquee direction="up" height="80%" onmouseover="this.stop();" onmouseout="this.start();" >
              <asp:DataList ID="DataList2"  runat="server">
                  <ItemTemplate>
                      ...
                      <a href='<%# Eval("newsLink") %>' style="color:red;" ><img src="img/new.jpg" width="30px" height="30px"  /><%# Eval("newsName") %></a>
        ...
        <div class="row justify-content-center">
          <div class="col-md-4 py-3 py-md-0">
            <div class="card-service wow fadeInUp">
             ...
             <%-- <a href="userLogin.aspx"><p><span>Book</span> Appointment</p></a>--%>
                <asp:LinkButton ID="LinkButton1" runat="server" OnClick="LinkButton1_Click"><span>Book</span> Appointment</asp:LinkButton>
            </div>
          </div>
          <div class="col-md-4 py-3 py-md-0">
            <div class="card-service wow fadeInUp">
             ...
             <asp:LinkButton ID="LinkButton2" runat="server" OnClick="LinkButton2_Click"><span>Book</span> Lab Test</asp:LinkButton>
          ...
          <div class="col-md-4 py-3 py-md-0">
            <div class="card-service wow fadeInUp">
              ...
              <asp:LinkButton ID="LinkButton3" runat="server" OnClick="LinkButton3_Click" ><span>Order</span> Medicine</asp:LinkButton>
