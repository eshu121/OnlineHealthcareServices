<%@ Page Title="" Language="C#" MasterPageFile="~/Layout/Doctor.Master" AutoEventWireup="true" CodeBehind="Appointment.aspx.cs" Inherits="OnlineHealthCareServices.Doctor.Appointment" %>
            ...
            <asp:Repeater ID="Repeater1" runat="server">
                ...
                <ItemTemplate>
                    <tr">
                        ...
                        <td>
                            <a href="Appointment_Update.aspx?AppId=<%# Eval("appointmentid")%>" class="btn" style='background-color:blue; color:#fff; border-radius:5px;'>Edit</a>
                        </td>
